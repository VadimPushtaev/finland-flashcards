# Orientation Learning Materials Progress

Track question counts per page in the Learning materials tree.

Rules:
- Fill "Questions" with the number of cards generated for that page's file.
- Use "Skip" with `yes` if we do not want questions for that page.
- Keep the page list unchanged; only update counts and skip flags.
