# Orientation Translations Progress (Russian)

Track which pages in the Orientation Learning materials tree have been
translated into Russian.

Rules:
- Fill "Translated" with `yes` when the Russian HTML exists under
  `translations/ru/orientation/...`.
- Use "Skip" with `yes` if we do not want to translate that page.
- Keep the page list unchanged; only update flags and notes.

| Page | Translated | Skip | Notes |
| --- | --- | --- | --- |
| Learning materials |  |  |  |
| \|-- Integration |  |  |  |
...
| \|   \|-- Finland's location and different areas |  |  |  |
...
| \|   \|-- Support for families in difficult situations |  |  |  |
...
| \|-- Finnish history |  |  |  |
| \|   \|-- Main periods of Finnish history 1: Finland as a part of Sweden and Russia | yes |  |  |
